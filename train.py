...
This script can be run in isolation, but is really meant to be part of an aml pipeline.
...
if transfer_learning:
    ...
    try:
        ...
        print("Didn't find model for this datata set (%s). \
        ...
        try:
            ...
            print("Warning! No model found in registry, cannot perform transfer learning!")
            print(e)
...
if transfer_learning:
    ...
    # all prednet layers are weirdly stored in the second layer of the overall trained_model 
