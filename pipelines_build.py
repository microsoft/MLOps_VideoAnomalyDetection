...
def build_pipeline(dataset, ws, config):
    ...
    cpu_cd = CondaDependencies.create(conda_packages=["py-opencv=3.4.2"], pip_packages=["azure-storage-blob==1.5.0", "hickle==3.4.3", "requests==2.21.0", "sklearn", "pandas==0.24.2", "azureml-sdk==1.0.30-core-patch", "numpy==1.16.2", "pillow==6.0.0"])
    gpu_cd = CondaDependencies.create(pip_packages=["keras==2.0.8", "theano==1.0.4", "tensorflow==1.8.0", "tensorflow-gpu==1.8.0", "hickle==3.4.3", "matplotlib==3.0.3", "seaborn==0.9.0", "requests==2.21.0", "bs4==0.0.1", "imageio==2.5.0", "sklearn", "pandas==0.24.2", "azureml-sdk==1.0.30-core-patch", "numpy==1.16.2"])
